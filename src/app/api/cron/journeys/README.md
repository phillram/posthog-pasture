...
When triggered, it generates a batch of simulated users running pre-built journey flows (Shopper, Window Shopper, New Signup, Search & Browse, Checkout Abandon by default) and sends the events to PostHog with timestamps spread across the past 24 hours so trend lines look natural rather than spiking.
